    ...
    <div className="flex flex-col gap-3 rounded-2xl border border-[#2a2f37] bg-[#1c2026] p-5">
      ...
      {state.status === "done" ? (
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-[10px] bg-[#22c55e] px-4 py-2 text-sm font-bold text-[#08150d] transition-opacity disabled:opacity-60"
        >
          {state.status === "saving" && (
            <span className="h-4 w-4 animate-spin rounded-full border-2 border-[#08150d]/30 border-t-[#08150d]" />
          )}
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <form
        ...
        className="sticky bottom-16 z-20 -mx-1 border-t border-[#2a2f37] bg-[#0d0f12]/95 px-1 pt-3 pb-3 backdrop-blur md:bottom-0"
      >
