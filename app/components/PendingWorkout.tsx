...
export function PendingWorkout() {
  ...
  return <aside className="mx-5 mt-5 rounded-xl border border-[#4ade80]/40 bg-[#1c2026] p-4">
    ...
    <p className="mt-1 text-sm text-[#9099a3]">Tus series, pesos y repeticiones están guardados. Abre una sesión para continuar, corregir su duración o terminarla.</p>
